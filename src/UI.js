...
function renderPlayerGameboard(player, box) {
  ...
  function attack(attempt = 0) {
    ...
    if (
      ...
      if (
        typeof player.gameboard.gameboard[colRandom][rowRandom] === "object"
      ) {
        player.gameboard.gameboard[colRandom][rowRandom] =
          player.gameboard.gameboard[colRandom][rowRandom].value;
...
export { renderPlayerGameboard, renderCompGameboard, modal };
